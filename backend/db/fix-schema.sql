-- Sweet TV Database Schema - COMPLETE VERSION
-- Copy and paste this entire file into Render Web Shell
...
-- ==================== LEADERBOARDS TABLE (WAS MISSING!) ====================
...
CREATE TABLE IF NOT EXISTS team_battle_teams (
  ...
  team_emoji VARCHAR(10),
  color VARCHAR(7) NOT NULL,
  user_group_ids INTEGER[] NOT NULL,
